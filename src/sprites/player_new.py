...
Updated to work with the new asset system.
"""
import pygame
import time
import math
...
class Player(pygame.sprite.Sprite):
    def __init__(self, image, sound_manager):
        ...
        self.asset_manager = None  # Will be set by the game manager
    ...
    def shoot(self):
        ...
        if now - self.last_shot > self.shoot_delay:
            ...
            # Get bullet image from asset manager if available
            bullet_image = None
            if self.asset_manager:
                bullet_image = self.asset_manager.get_image('bullet')
